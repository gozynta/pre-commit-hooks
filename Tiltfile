...
docker_build(
    ...
    only=["Dockerfile.alpine", "pyproject.toml", "poetry.lock", "poetry.toml", "LICENSE"]
    + all_pysrc_py_files(PROJECT_ROOT),
)
...
docker_build(
    ...
    only=["Dockerfile.debian", "pyproject.toml", "poetry.lock", "poetry.toml", "LICENSE"]
    + all_pysrc_py_files(PROJECT_ROOT),
)
